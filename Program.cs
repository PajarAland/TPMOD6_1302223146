...
namespace MOD6_1302223146
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                SayaTubeVideo video1 = new SayaTubeVideo("fajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajarfajar");
            ...
            try
            {
                SayaTubeVideo video3 = new SayaTubeVideo("Tutor Design By Contract - Fajar Ramadhan");
            ...
            try
            {
                SayaTubeVideo video4 = new SayaTubeVideo("Tutor Design By Contract - Fajar Ramadhan");
